...
namespace orb
{
	...
	private:
		...
		// The size of the patch used by the oriented BRIEF descriptor.							//定向BRIEF描述符使用的patch大小
		int patch_size = 31;
		...
		float* vmem = NULL;
															// Shared memory of score maps for non-max suppression
		// Size of memory
		size_t obytes = 0;
		size_t vbytes = 0;
